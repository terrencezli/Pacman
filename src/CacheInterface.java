...
public interface CacheInterface {
     ...
     * @return value the value to which the specified key is cached, or null if
     *         the cache dosn't contain the key
     */
     ...
     * the cache previously contained the key, the old value is replaced.
     *
     * @param key
    ...
    /**
     * This method should be used for testing. Returns false on an error.
     *
